...
class VO_Carson : Preprocessor<String> {
    ...
    fun runVO(timeStep: Double, firstImage: IntArray, secondImage: IntArray, h: Double, f: DoubleArray,
              c: DoubleArray, firstCamToNav: Matrix<Double>, secondCamToNav: Matrix<Double>, t: Time,
              filterVel: Matrix<Double>, processor: String, measCov: Matrix<Double>, params: BooleanArray): Measurement {


        //get translation vector
        val translation = runVO.VO(firstImage, secondImage, h, f, c, firstCamToNav, secondCamToNav, params)
