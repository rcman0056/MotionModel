 ...
 *
 */
class SimulatedRangeMeasurementProcessor : MeasurementProcessor {
    ...
    override fun generateModel(meas: Measurement, xhat: Matrix<Double>, P: Matrix<Double>): MeasurementModel {
        ...
        var CenterX = Curr_Meas.simulated_range_CenterNEU[0]
        var CenterY = Curr_Meas.simulated_range_CenterNEU[1]
        var CenterZ = Curr_Meas.simulated_range_CenterNEU[2]
        var Speed = Curr_Meas.simulated_range_ground_speed
        var Radius = Curr_Meas.simulated_range_radius
        var dt_total = Curr_Meas.simulated_range_total_dt
        var pi = Math.PI

        var Angle_diff=-(dt_total*Speed)/(2*pi*Radius)    //+pi/2; //add the pi/2 to get a plane offset //Negative ang makes the plane fly clock wise
